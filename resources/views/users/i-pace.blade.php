...
<body class="relative bg-black text-white font-[Josefin Sans] overflow-x-hidden">
  ...
  <section class="relative flex items-center justify-center w-screen h-[100dvh] bg-black overflow-hidden">
    <video autoplay muted loop playsinline
      ...
      <source src="./media/Jaguar I-PACE   After Hours London.mp4" type="video/mp4" />
    </video>
...
<div class="relative flex justify-center items-center h-40 border-b border-gray-700">
  <h4 class="absolute top-2 left-5 text-[0.6rem] text-gray-400 tracking-wider exo-font">EV Range (Up To)</h4>
  <h1 class="text-8xl font-light text-white josefin-font"><span>470</span><span class="text-4xl ml-2">km</span></h1>
</div>

<div class="relative flex justify-center items-center h-40 border-b border-gray-700">
  <h4 class="absolute top-2 left-5 text-[0.6rem] text-gray-400 tracking-wider exo-font">Emissions</h4>
  <h1 class="text-8xl font-light text-white josefin-font"><span>0</span><span class="text-4xl ml-2">CO²</span></h1>
</div>

<div class="relative flex justify-center items-center h-40 border-b border-gray-700">
  <h4 class="absolute top-2 left-5 text-[0.6rem] text-gray-400 tracking-wider exo-font">Charging Time</h4>
  <h1 class="text-8xl font-light text-white josefin-font"><span>8.58</span><span class="text-4xl ml-2">Hours</span></h1>
</div>
...
<div class="relative flex justify-center items-center h-40">
  ...
  <h1 class="text-8xl font-light text-white josefin-font"><span>4.8</span><span class="text-4xl ml-2">s</span></h1>
</div>
</div>
</section>
...
<img src="./media/I-PACE EXTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
<img src="./media/I-PACE EXTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
<img src="./media/I-PACE EXTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
</div>
</section>
...
<div class="relative w-full max-w-6xl flex items-center justify-center">
<img src="./media/I-PACE INTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
<img src="./media/I-PACE INTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
<img src="./media/I-PACE INTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
</div>
</section>
