...
<body class="relative bg-black text-white font-[Josefin Sans] overflow-x-hidden">
  ...
  <section class="relative flex items-center justify-center w-screen h-[100dvh] bg-black overflow-hidden">
    ...
    <video autoplay muted loop playsinline
      ...
      <source src="./media/Jaguar Classic   E-type Series 1 Reborn.mp4" type="video/mp4" />
    </video>
  ...
  <section id="section-exterior"
    ...
    <div class="relative w-full max-w-6xl flex items-center justify-center">
      <img src="./media/E-TYPE EXTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
      <img src="./media/E-TYPE EXTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
      <img src="./media/E-TYPE EXTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
    </div>
  </section>
  ...
  <section id="section-interior"
    ...
    <div class="relative w-full max-w-6xl flex items-center justify-center">
      <img src="./media/E-TYPE INTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
      <img src="./media/E-TYPE INTERIOR 2.svg" alt="Dashboard" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
      <img src="./media/E-TYPE INTERIOR 3.svg" alt="Seats" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
    </div>
  </section>
