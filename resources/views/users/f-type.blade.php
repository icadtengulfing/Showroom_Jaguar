...
<section class="relative flex items-center justify-center w-screen h-[100dvh] bg-black overflow-hidden">
  ...
  <video autoplay muted loop playsinline
    ...
    <source src="./media/jaguar-ftype-after-hours.mp4" type="video/mp4" />
  </video>
...
class="relative flex flex-col items-center justify-center w-screen min-h-screen overflow-hidden bg-cover bg-center"
...
<div class="fade-section">
  <h2 class="mt-10 text-3xl font-semibold uppercase tracking-[0.1em] text-white josefin-font text-center mb-8">
    MODEL 360°
  </h2>
  <h3 class="mt-10 text-3md font-semibold uppercase tracking-[0.1em] text-white josefin-font text-center mb-8">
    Convertible
  </h3>
  <div class="cloudimage-360"
       data-folder="/images/ftypeconvertible/"
...
<div class="mt-2"></div>
 <!-- Card List -->
 <div class="relative flex flex-col divide-y divide-gray-700">
  <div class="flex justify-center items-center h-40 relative">
    ...
    <h1 class="text-8xl font-light josefin-font"><span>300</span><span class="text-4xl ml-2">km/h</span></h1>
  </div>

  <div class="flex justify-center items-center h-40 relative">
    <h4 class="absolute top-2 left-5 text-[0.6rem] text-gray-400 tracking-wider exo-font">Acceleration</h4>
    <h1 class="text-8xl font-light josefin-font"><span>3.7</span><span class="text-4xl ml-2">km/h</span></h1>
  </div>

  <div class="flex justify-center items-center h-40 relative">
    <h4 class="absolute top-2 left-5 text-[0.6rem] text-gray-400 tracking-wider exo-font">Maximum Power</h4>
    <h1 class="text-8xl font-light josefin-font"><span>575</span><span class="text-4xl ml-2">ps</span></h1>
  </div>

  <div class="flex justify-center items-center h-40 relative">
    <h4 class="absolute top-2 left-5 text-[0.6rem] text-gray-400 tracking-wider exo-font">Maximum Torque</h4>
    <h1 class="text-8xl font-light josefin-font"><span>700</span><span class="text-4xl ml-2">Nm</span></h1>
  </div>
</div>
</div>
</section>
...
<img src="./media/F-TYPE EXTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
<img src="./media/F-TYPE EXTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
<img src="./media/F-TYPE EXTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
</div>
</section>
...
<div class="relative w-full max-w-6xl flex items-center justify-center">
<img src="./media/F-TYPE INTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
<img src="./media/F-TYPE INTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
<img src="./media/F-TYPE INTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
</div>
</section>
