...
<head>
  ...
  <title>Official JAGUAR Website - E-PACE</title>
...
<body class="relative bg-black text-white font-[Josefin Sans] overflow-x-hidden">
  ...
  <!-- Overlay -->
  <div id="overlay"
       class="fixed inset-0 hidden z-30 bg-black/40 backdrop-blur-sm transition-all duration-500">
  </div>
  ...
  <section class="relative flex items-center justify-center w-screen h-[100dvh] bg-black overflow-hidden">
    <video autoplay muted loop playsinline
      ...
      <source src="./media/Jaguar E-PACE   Power of Plug-in Hybrid.mp4" type="video/mp4" />
    </video>
  ...
  <h2 class="text-3xl font-semibold uppercase tracking-[0.1em] text-white josefin-font">
    SPECIFICATIONS
      ...
      <div class="relative flex justify-center items-center h-40 border-b border-gray-700">
        <h4 class="absolute top-2 left-5 text-[0.6rem] text-gray-400 tracking-wider exo-font">
          EV Range (Up To)
        </h4>
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>60</span><span class="text-4xl ml-2">km</span>
        </h1>
      </div>
      ...
      <div class="relative flex justify-center items-center h-40 border-b border-gray-700">
        ...
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>33</span><span class="text-4xl ml-2">g/km</span>
        </h1>
      </div>
      ...
      <div class="relative flex justify-center items-center h-40 border-b border-gray-700">
        ...
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>1.4</span><span class="text-4xl ml-2">(194,8)</span>
        </h1>
      </div>
      ...
      <div class="relative flex justify-center items-center h-40">
        ...
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>601</span><span class="text-4xl ml-2">Litres</span>
        </h1>
      </div>
    </div>
  </section>
  ...
  <section id="section-exterior"
    ...
    <h2 class="text-xl josefin-font uppercase tracking-[0.3em] text-gray-200 mb-6">
      Exterior
    </h2>

    <div class="relative w-full max-w-6xl flex items-center justify-center">
      <img src="./media/E-PACE EXTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
      <img src="./media/E-PACE EXTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
      <img src="./media/E-PACE EXTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
    </div>
  </section>
  ...
  <section id="section-interior"
    ...
    <div class="relative w-full max-w-6xl flex items-center justify-center">
      <img src="./media/E-PACE INTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
      <img src="./media/E-PACE INTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
      <img src="./media/E-PACE INTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
    </div>
  </section>
