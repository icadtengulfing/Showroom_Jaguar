...
<head>
  ...
  <title>Official JAGUAR Website - F-PACE</title>
...
<body class="relative bg-black text-white font-[Josefin Sans] overflow-x-hidden">
  ...
  <section class="relative flex items-center justify-center w-screen h-[100dvh] bg-black overflow-hidden">
    <video autoplay muted loop playsinline 
      ...
      <source src="./media/Jaguar F-PACE   Midnight Carwash.mp4" type="video/mp4" />
    </video>
    ...
    SPECIFICATIONS
      ...
      <div class="relative flex justify-center items-center h-40 border-b border-gray-700">
        ...
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>64</span><span class="text-4xl ml-2">km</span>
        </h1>
      </div>
      ...
      <div class="relative flex justify-center items-center h-40 border-b border-gray-700">
        ...
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>39</span><span class="text-4xl ml-2">g/km</span>
        </h1>
      </div>
      ...
      <div class="relative flex justify-center items-center h-40 border-b border-gray-700">
        ...
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>1.7</span><span class="text-4xl ml-2">(194,8)</span>
        </h1>
      </div>
      ...
      <div class="relative flex justify-center items-center h-40">
        ...
        <h1 class="text-8xl font-light text-white josefin-font">
          <span>1.842</span><span class="text-4xl ml-2">Litres</span>
        </h1>
      </div>
    </div>
  </section>
  ...
  <section id="section-exterior" 
    ...
    <div class="relative w-full max-w-6xl flex items-center justify-center">
      <img src="./media/F-PACE EXTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
      <img src="./media/F-PACE EXTERIOR 2.svg" alt="Headlight" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
      <img src="./media/F-PACE EXTERIOR 3.svg" alt="Tail Light" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
    </div>
  </section>
  ...
  <section id="section-interior" 
    ...
    <div class="relative w-full max-w-6xl flex items-center justify-center">
      <img src="./media/F-PACE INTERIOR 1.svg" alt="Front View" class="relative z-10 w-[550px] rounded-sm object-cover" />
      <img src="./media/F-PACE INTERIOR 2.svg" alt="Dashboard" class="absolute z-20 w-[420px] right-[90px] bottom-[-60px] rounded-sm object-cover" />
      <img src="./media/F-PACE INTERIOR 3.svg" alt="Seats" class="absolute z-30 w-[420px] left-[100px] bottom-[-120px] rounded-sm object-cover" />
    </div>
  </section>
